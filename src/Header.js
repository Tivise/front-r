        ...
        <Bounce top cascade>
          ...
          <section id="m-center">
            ...
            <ul>
              ...
              <li><Link className={pathname === '/universe' ? ((settings.factionSelected === 1 || settings.factionSelected === 0 ? 'rivandy-color':'dechys-color') + ' selected-link') : 'disabled-link'} to="/">Universe</Link></li>
